...
let wishListButtons = document.querySelectorAll(
  "button.product-item__wish-list-btn"
);
...
function addToWishList() {
  ...
  setTimeout(() => messageDialog.dispatchEvent(closeDialogEvent), 10000);
}
